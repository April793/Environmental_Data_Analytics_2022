...
NTL.phys.data <- read.csv("./Data/Raw/NTL-LTER_Lake_ChemistryPhysics_Raw.csv", stringsAsFactors = TRUE) #April exercised
read.csv(file.choose()) #April exercised
...
NTL.phys.data$sampledate <- as.Date(NTL.phys.data$sampledate, format = "%m/%d/%y") #April
class(NTL.phys.data$sampledate) #April
head(NTL.phys.data$sampledate) #April
```
