...
NAFact(USGS.flow.data$discharge.mean.approval)
summary(NAFact)
# April
summary(USGS.flow.data$discharge.mean.approval)
length(USGS.flow.data$discharge.mean.approval)
na.omit(USGS.flow.data$discharge.mean.approval)
length(USGS.flow.data$discharge.mean.approval)

#check na
is.na(USGS.flow.data$discharge.mean.approval)
#turned "" into na
...
Kept1 <- NAkeep(USGS.flow.data$discharge.mean.approval)
Kept1

USGS.flow.data$discharge.mean.approval <- NAkeep(USGS.flow.data$discharge.mean.approval)
